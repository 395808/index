...
function switchBtnClass() {
    ...
    if (secondsTemp % 2 == 0) {
        ...
        $('#btn-7').parent("a").attr("href", "https://32co.github.io/Index/go.html?url=https://mark.dolyw.com");
    } else {
        $('#btn-7').html("友链");
        $('#btn-7').parent("a").attr("href", "https://32co.github.io/Index/go.html?url=https://friend.dolyw.com");
    } */
    // 切换按钮颜色
    var btnClassIndex = 1;
